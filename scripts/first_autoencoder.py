...
train_tuple=(train_file, 3498)
train_and_test_model(model=autoencoder, modelname="autoencoder_test", train_files=train_tuple, test_files=train_tuple, batchsize=32, n_bins=(11,13,18,1), class_type=None, xs_mean=None, epoch=0,
