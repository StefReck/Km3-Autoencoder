...
def extra_autoencoder_stages_setup(autoencoder_stage, ae_loss_name, 
                                   supervised_loss):
    """
    ...
    return (autoencoder_stage, ae_loss_name, supervised_loss, 
...
def build_model(autoencoder_stage, modeltag, epoch, optimizer, ae_loss, 
    ...
    if autoencoder_stage==0:
        ...
        model = setup_autoencoder_model(modeltag, epoch, optimizer, ae_loss, 
                                        options, custom_objects, model_folder, 
                                        modelname)
    ...
    #epoch is calculated automatically and not used from user input
        ...
        model = setup_encoder_dense_model(
                modeltag, encoder_epoch, modelname, 1, number_of_output_neurons, 
                supervised_loss, supervised_metrics, optimizer, options, 
                model_folder, custom_objects, autoencoder_model)
