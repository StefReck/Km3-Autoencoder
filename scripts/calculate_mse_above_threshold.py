# -*- coding: utf-8 -*-
"""
Calculate the mse of bins above a threshold for some autoencoders.
"""
...
model_base=home_path+"models/vgg_5_picture-instanthighlr/trained_vgg_5_picture-instanthighlr_autoencoder_epoch"
...
with open(name_of_log_file, 'a') as logfile:
    ...
    for epoch in epochs_of_model:
        ...
        autoencoder = load_model(model_base+str(epoch)+".h5")
